...
if API_KEY:
    ...
    # Using 2.5-flash since you have a paid tier!
    ...
    def remove_stock_callback(ticker_to_remove):
        ...
        # If the user deletes the stock they were currently looking at, clear the main screen
    ...
    def open_watchlist_manager():
                    ...
                    if response.status_code == 200:
                        ...
                        if valid_matches:
                            ...
                            if dropdown_selection != "-- Select Company --":
                                ...
                                comp_name = chosen_item["company_name"]
                                
                                st.button(
                                    f"➕ Add {saved_ticker} to List", 
                                    key=f"add_btn_{saved_ticker}", 
                                    on_click=add_stock_callback, 
                                    args=(saved_ticker, comp_name),
        ...
        if not st.session_state.my_watchlist:
            st.info("Your watchlist is currently empty. Search for a stock above to get started!")
        else:
    ...
    if st.session_state.active_ticker is None:
        ...
        st.write("To get started, click the **⚙️ Manage My Stock List** button in the sidebar to build your custom portfolio and analyze your first stock.")
    
    else:
        # The main analysis UI only renders if a stock is actively selected
